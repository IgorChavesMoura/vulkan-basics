...
class HelloTriangleApplication {
	...
	private:
		...
		void pickPhysicalDevice() {
			...
			std::cout << "Picked GPU: " << physicalDeviceProperties.deviceName << std::endl;
		...
		void createGraphicsPipeline() {
			...
			std::cout << "Vertex Shader buffer size: " << vertShaderCode.size() << std::endl;
			std::cout << "Fragment Shader buffer size: " << fragShaderCode.size() << std::endl;
		...
		static std::vector<char> readFile(const std::string& filename) {
			...
			std::ifstream file(filename, std::ios::ate | std::ios::binary); //Start to read at the end of the file as a binary
